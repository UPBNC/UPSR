...
public interface StatisticService {
    ...
    List<Map<String,List<IfStatisticsServiceEntity>>> getIfStatistics(String routerId, int entityNum);
    List<Map<String,List<IfClearedStatServiceEntity>>> getIfClearedStat(String routerId, int entityNum);
    List<Map<String,List<CpuInfoServiceEntity>>> getCpuInfo(String routerId, int entityNum);
    List<Map<String,List<MemoryInfoServiceEntity>>> getMemoryInfo(String routerId, int entityNum);
