...
public class STnlSelSeq {//Sequence in which different types of tunnels are selected. If the value is INVALID, no tunnel type has been configured
    ...
    public STnlSelSeq(int loadBalanceNum, String selTnlType1, String selTnlType2, String selTnlType3,
