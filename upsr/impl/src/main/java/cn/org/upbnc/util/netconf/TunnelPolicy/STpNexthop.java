...
public class STpNexthop {//Rule for binding a TE tunnel to a destination address, so that the VPN traffic destined for
    ...
    public STpNexthop(String nexthopIPaddr, boolean downSwitch, boolean ignoreDestCheck, boolean isIncludeLdp,
