...
public class UpsrCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(UpsrCliTestCommand.class);
    protected final UpsrCliCommands service;

    public UpsrCliTestCommand(final UpsrCliCommands service) {
